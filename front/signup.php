...
function check_pass() {
    if (document.getElementById('signPW').value == document.getElementById('signPW-confirm').value) {
		...
		else if (document.getElementById('signPW-confirm').value != "" || document.getElementById('signPW-confirm').value != null) {
        ...
        <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block">
			  	<img src="assets/signup_background.jpg" alt="Dungeons & Dragons" class="img-responsive">
			  </div>
              <div class="col-lg-6">
                <div class="p-5">
